# =========================================================
# R-M4: non-spatial same-week covariates plus lagged cases using R-INLA
# =========================================================
# Converted from base_model_lag_cases.py.
# Uses same-week rainfall, humidity, temperature, IDHM, and four-week log lagged cases.
...
MODEL_ID <- "R_M4"
MODEL_DESCRIPTION <- "base + same-week covariates + log lagged cases"
...
CRITERIA_CSV <- file.path(OUTPUT_DIR, "r_m4_model_criteria.csv")
METRICS_CSV <- file.path(OUTPUT_DIR, "r_m4_train_test_metrics.csv")
FIXED_EFFECTS_CSV <- file.path(OUTPUT_DIR, "r_m4_fixed_effects.csv")
