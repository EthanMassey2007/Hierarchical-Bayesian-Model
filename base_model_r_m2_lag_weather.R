# =========================================================
# R-M2: non-spatial lagged-weather covariate model using R-INLA
# =========================================================
# Converted from base_model_lag_weather.py.
# Uses twelve-week lagged rainfall, humidity, temperature, and IDHM.
...
MODEL_ID <- "R_M2"
MODEL_DESCRIPTION <- "base + 12-week lagged weather covariates"
...
CRITERIA_CSV <- file.path(OUTPUT_DIR, "r_m2_model_criteria.csv")
METRICS_CSV <- file.path(OUTPUT_DIR, "r_m2_train_test_metrics.csv")
FIXED_EFFECTS_CSV <- file.path(OUTPUT_DIR, "r_m2_fixed_effects.csv")
