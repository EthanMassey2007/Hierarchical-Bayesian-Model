# =========================================================
# R-M5: non-spatial fixed-rainfall benchmark using R-INLA
# =========================================================
# Converted from base_model_lag_cases_weather.py.
# Uses lagged weather, IDHM, and four-week log lagged cases.
...
MODEL_ID <- "R_M5"
MODEL_DESCRIPTION <- "base + lagged weather + log lagged cases"
...
CRITERIA_CSV <- file.path(OUTPUT_DIR, "r_m5_model_criteria.csv")
METRICS_CSV <- file.path(OUTPUT_DIR, "r_m5_train_test_metrics.csv")
FIXED_EFFECTS_CSV <- file.path(OUTPUT_DIR, "r_m5_fixed_effects.csv")
