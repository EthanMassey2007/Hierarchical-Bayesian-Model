# =========================================================
# R-M1: non-spatial same-week covariate model using R-INLA
# =========================================================
# Converted from base_model_covariates.py.
# Uses same-week rainfall, humidity, temperature, and IDHM.
...
MODEL_ID <- "R_M1"
MODEL_DESCRIPTION <- "base + same-week covariates"
...
CRITERIA_CSV <- file.path(OUTPUT_DIR, "r_m1_model_criteria.csv")
METRICS_CSV <- file.path(OUTPUT_DIR, "r_m1_train_test_metrics.csv")
FIXED_EFFECTS_CSV <- file.path(OUTPUT_DIR, "r_m1_fixed_effects.csv")
