...
# =========================================================
# Restrict weekly core dataset to 2017-2022
# =========================================================
...
# =========================================================
# Numeric conversion + weekly core panel from combined file
# =========================================================
...
# =========================================================
# Aggregate weekly core data
# =========================================================
df = (
    combined_df.groupby(["municipio", "year", "week"], as_index=False)
    .agg(
        {
            "cases": "sum",
            "temperature": "mean",
