...
plot_rainfall_municipality_map <- function(effects) {
  ...
  p <- ggplot(map_sf) +
    ...
    labs(
      ...
      caption = "Municipality component from additive municipality + RW1 time rainfall slopes. Blue values below 1 indicate lower expected cases; white at RR = 1 indicates no change; red values above 1 indicate higher expected cases."
    ) +
